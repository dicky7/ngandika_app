  ...
  Future<Either<Failure, void>> getAllContacts() async {
    try {
      ...
      final result = await remoteDataSource
          .getAllContacts(await localDataSource.getContactLocal());
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(ServerFailure(
          "repository getAllContacts DatabaseException${e.message}"));
    } on ServerException catch (e) {
      return Left(ServerFailure(
          "repository getAllContacts ServerException${e.message}"));
    }
  }
